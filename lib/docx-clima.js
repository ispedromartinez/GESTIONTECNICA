...
async function buildDocx(d) {
  ...
  const HDR_BLUE2 = 'D6E4F0';
  const HDR_BRD   = '1A3A6C';
  ...
  try {
    ...
    const headerTable = new Table({
      ...
      borders: { top: thinHdr(), bottom: thinHdr(), left: thinHdr(), right: thinHdr(), insideH: thinHdr(), insideV: thinHdr() },
      rows: [
        new TableRow({
          height: { value: 450 },
          children: [
            new TableCell({
              width: { size: 2563, type: WidthType.DXA }, rowSpan: 2,
              borders: allHdr, verticalAlign: VerticalAlign.CENTER,
            ...
            new TableCell({
              width: { size: 4625, type: WidthType.DXA }, borders: allHdr,
            ...
            new TableCell({
              width: { size: 745, type: WidthType.DXA }, borders: allHdr,
            ...
            new TableCell({
              width: { size: 1936, type: WidthType.DXA }, borders: allHdr,
              verticalAlign: VerticalAlign.CENTER, margins: { top: 20, bottom: 20, left: 40, right: 40 },
              children: [new Paragraph({
                alignment: AlignmentType.CENTER, spacing: { before: 0, after: 0 },
